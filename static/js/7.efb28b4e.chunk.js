...
`,g=e=>{let{bTokens:t=[]}=e;const a=360/t.length;return Object(u.jsxs)(O,{className:"v3-tokens",children:[Object(u.jsx)("div",{className:"tokens",children:t.filter(((e,t)=>t<3)).map(((e,t)=>Object(u.jsx)("div",{className:"base-token-box-bg",children:Object(u.jsx)("div",{className:`base-token-bg ${e.bTokenSymbol}`})},t)))}),Object(u.jsxs)("div",{className:"base-token-box-bg explode",children:[Object(u.jsxs)("div",{className:"base-token-bg",children:[t.length-3," +"]}),t.map(((e,t)=>{const s=a*t;return Object(u.jsx)(f,{className:"base-token",rotate:s,width:"100",children:Object(u.jsx)("div",{width:"100",rotate:s,className:`base-token-bg move ${e.bTokenSymbol}`})},t)}))]})]})}},1955:function(e,t,a){}}]);
//# sourceMappingURL=7.efb28b4e.chunk.js.map